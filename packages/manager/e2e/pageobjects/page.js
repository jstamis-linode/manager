...
export default class Page {
    ...
    openActionMenu(actionMenuRow) {
        browser.waitForDisplayed(`${actionMenuRow.selector} ${this.actionMenu.selector}`, constants.wait.normal);
    ...
    selectActionMenuItemV2(tableCellSelector, item, index=0){
      ...
      actionMenu.click();
      browser.waitForDisplayed(this.actionMenuItem.selector, constants.wait.normal);
